...
CREATE TABLE IF NOT EXISTS `Orphanet`.`Orphanet_EpidemiologicalDiseaseInfo` (
  ...
  `type` VARCHAR(45) NULL COMMENT 'Type of concept (Biological anomaly, Clinical subtype, Clinical syndrome, Disease, Etiological subtype, Group of phenomes, Histopathological subtype, Malformation syndrome, Morphological anomaly, Particular clinical situation in a disease or syndrome )',
  `prevalenceType` VARCHAR(45) NULL COMMENT 'Type of prevalence presented:\nPoint prevalence: Number of cases scaled up to the general population at a given time. \n\nBirth prevalence: Number of cases observed at birth relative to the number of children born alive at a given moment.\n\nAnnual incidence: Number of newly diagnosed cases in a population in one year. \n\nLifetime prevalence: Number of cases presenting or having presented the clinical entity during their lifetime scaled up to the general population. \nCases/families: Number of cases or family (ies) published in the literature.',
  `prevalenceQualification` VARCHAR(45) NULL COMMENT 'Identication on the type of information available: prevalenceClass and/or prevalenceValue',
  `prevalenceGeographic` VARCHAR(45) NULL COMMENT 'Geographic location of prevalence information',
  ...
  `prevalenceValue` VARCHAR(45) NULL COMMENT 'Value of prevalence: in case of case this is the number of cases per geographic location',
  `prevalenceValidationStatus` VARCHAR(45) NULL COMMENT 'Validation status of the prevalence: Validated, Not yet validated',
  `prevalenceSource` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `Orphanet`.`Orphanet_DiseaseVariants` (
  ...
  `label` VARCHAR(100) NULL,
  `prevalenceSource` VARCHAR(100) NULL,
  `Ens_gene` VARCHAR(45) NULL,
  `associationType` VARCHAR(100) NULL,
  `associationStatus` VARCHAR(45) NULL,
  PRIMARY KEY (`DB`, `id`),
